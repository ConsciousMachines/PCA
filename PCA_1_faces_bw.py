...
# i think the latent space is theoretically N(0,1) - TODO: should it be? are the dependencies linear?
...
class Soy():
    ...
    def refresh(self, e):
        self.reconstruct()
        self.xdata                              = b'P5 64 64 255 ' + self.x.tobytes()
        self.photo                              = tk.PhotoImage(width=siz, height=siz, data=self.xdata, format = 'PPM').zoom(8)
